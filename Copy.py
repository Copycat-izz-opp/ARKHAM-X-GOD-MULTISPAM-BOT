...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await idk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await idk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await idk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await idk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await adk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await adk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await adk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await adk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await edk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await edk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await edk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await edk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await sid(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sid(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sid(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await sid(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await shy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await aan(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aan(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aan(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aan(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await ake(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ake(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ake(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await ake(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await eel(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eel(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eel(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eel(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await khu(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await khu(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await khu(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await khu(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await shi(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shi(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shi(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await shi(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await dav(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await dav(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await dav(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await dav(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await raj(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await raj(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await raj(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await raj(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await put(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await put(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await put(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await put(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await eag(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eag(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eag(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await eag(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await gle(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await gle(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await gle(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await gle(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await wal(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wal(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wal(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await wal(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@Astro_HelpChat"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await aaa(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await boy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await boy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await boy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
            await boy(functions.channels.JoinChannelRequest(channel="@SESSION_GROUPS"))
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "𝗚𝗢𝗗ꨄ︎ 𝐒𝐏𝐀𝐌𝐁𝐎𝐓ꨄ︎ 𝐎𝐏 🥵🔥!"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        end = datetime.now()
        ms = (end-start).microseconds / 1000
        await event.edit(f"✰𝗣𝗢𝗡𝗚ꨄ︎!\n`{ms}` ms ")
...
print(text)
print("")
print("𝗚𝗢𝗗ꨄ︎ 𝗦𝗣𝗔𝗠 𝗕𝗢𝗧 𝗥𝗘𝗔𝗗𝗬 𝗙𝗢𝗥 𝗨𝗦𝗘 𝗖𝗛𝗘𝗖𝗞 𝗕𝗬 𝗗𝗢𝗜𝗡𝗚 *ping")
